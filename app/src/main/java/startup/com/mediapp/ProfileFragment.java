...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView name = (TextView)v.findViewById(R.id.nam);
        ...
        sharedPref.getString("loc", defaultValue) +"\n"+
        sharedPref.getString("city", defaultValue)+", "+
                sharedPref.getString("state", defaultValue)+"\n"+
                sharedPref.getString("pincode", defaultValue);
